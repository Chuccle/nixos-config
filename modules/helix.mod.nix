      ...
      xdg.config.files."helix/languages.toml".value = {
        ...
        language-server.rust-analyzer = {
          config = {
            ...
            completion.excludeTraits = singleton "yansi::Paint";
        ...
        language =
          ...
          ++ [
...

            {
              name = "python";
              auto-format = true;
              language-servers = singleton "basedpyright";
            }
              ...
              debugger.templates = singleton {
                ...
                args.initCommands =
                  let
                    ...
                    '';
                  in
                  singleton "command script import ${primer}/primer.py";
              };
            }
